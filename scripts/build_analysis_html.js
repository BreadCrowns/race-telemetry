...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* SIDEBAR DRAWER (RUN SELECTOR & LEADERBOARD) */
    .sidebar {
      width: 380px;
      background: #090e1a;
...
<body>
  ...
  <header class="app-header">
    <div class="header-left">
      <button type="button" class="btn-toggle-sidebar" onclick="toggleSidebar()">☰ Runs</button>
      <a href="pitwall.html" class="btn-back">← Pit Wall</a>
      <div class="header-title">
        <span>🏁 SONOMA RACEWAY AUTOCROSS</span>
  ...
  <div class="main-workspace">
    ...
    <div class="map-container-wrap">
      ...
      <div class="bottom-telemetry-panel">
